        ...
        tailwindcss({
            config: {
                ...
                safelist: [
                    ...
                    // BACKGROUND COLORS
                    'bg-[slate]', 'bg-[gray]', 'bg-[zinc]', 'bg-[neutral]', 'bg-[stone]', 'bg-[red]', 'bg-[orange]', 'bg-[amber]', 'bg-[yellow]', 'bg-[lime]', 'bg-[green]', 'bg-[emerald]', 'bg-[teal]', 'bg-[cyan]', 'bg-[sky]', 'bg-[blue]', 'bg-[indigo]', 'bg-[violet]', 'bg-[purple]', 'bg-[fuchsia]', 'bg-[pink]', 'bg-[rose]', 'bg-[black]', 'bg-[white]', 'bg-[transparent]',

                    // TEXT COLORS
                    'text-[slate]', 'text-[gray]', 'text-[zinc]', 'text-[neutral]', 'text-[stone]', 'text-[red]', 'text-[orange]', 'text-[amber]', 'text-[yellow]', 'text-[lime]', 'text-[green]', 'text-[emerald]', 'text-[teal]', 'text-[cyan]', 'text-[sky]', 'text-[blue]', 'text-[indigo]', 'text-[violet]', 'text-[purple]', 'text-[fuchsia]', 'text-[pink]', 'text-[rose]', 'text-[black]', 'text-[white]', 'text-[transparent]',

                    // BORDER COLORS
                    'border-[slate]', 'border-[gray]', 'border-[zinc]', 'border-[neutral]', 'border-[stone]', 'border-[red]', 'border-[orange]', 'border-[amber]', 'border-[yellow]', 'border-[lime]', 'border-[green]', 'border-[emerald]', 'border-[teal]', 'border-[cyan]', 'border-[sky]', 'border-[blue]', 'border-[indigo]', 'border-[violet]', 'border-[purple]', 'border-[fuchsia]', 'border-[pink]', 'border-[rose]', 'border-[black]', 'border-[white]', 'border-[transparent]',

                    // RING COLORS (FOR FOCUS OUTLINES)
                    'ring-[slate]', 'ring-[gray]', 'ring-[zinc]', 'ring-[neutral]', 'ring-[stone]', 'ring-[red]', 'ring-[orange]', 'ring-[amber]', 'ring-[yellow]', 'ring-[lime]', 'ring-[green]', 'ring-[emerald]', 'ring-[teal]', 'ring-[cyan]', 'ring-[sky]', 'ring-[blue]', 'ring-[indigo]', 'ring-[violet]', 'ring-[purple]', 'ring-[fuchsia]', 'ring-[pink]', 'ring-[rose]', 'ring-[black]', 'ring-[white]', 'ring-[transparent]',

                    // FILL COLORS (FOR SVG)
                    'fill-[slate]', 'fill-[gray]', 'fill-[zinc]', 'fill-[neutral]', 'fill-[stone]', 'fill-[red]', 'fill-[orange]', 'fill-[amber]', 'fill-[yellow]', 'fill-[lime]', 'fill-[green]', 'fill-[emerald]', 'fill-[teal]', 'fill-[cyan]', 'fill-[sky]', 'fill-[blue]', 'fill-[indigo]', 'fill-[violet]', 'fill-[purple]', 'fill-[fuchsia]', 'fill-[pink]', 'fill-[rose]', 'fill-[black]', 'fill-[white]', 'fill-[transparent]',

                    // STROKE COLORS (FOR SVG)
                    'stroke-[slate]', 'stroke-[gray]', 'stroke-[zinc]', 'stroke-[neutral]', 'stroke-[stone]', 'stroke-[red]', 'stroke-[orange]', 'stroke-[amber]', 'stroke-[yellow]', 'stroke-[lime]', 'stroke-[green]', 'stroke-[emerald]', 'stroke-[teal]', 'stroke-[cyan]', 'stroke-[sky]', 'stroke-[blue]', 'stroke-[indigo]', 'stroke-[violet]', 'stroke-[purple]', 'stroke-[fuchsia]', 'stroke-[pink]', 'stroke-[rose]', 'stroke-[black]', 'stroke-[white]', 'stroke-[transparent]',
